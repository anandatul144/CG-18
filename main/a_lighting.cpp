...
void renderCornellboxB(float scale, const char* filename) {
    ...
    //world.light.push_back(new ProjectiveLight (Point(520.f, 300.f, 230.f)*scale));
...
void renderCornellboxJ(float scale, const char* filename) {
    Image img(400, 400);
    World world;
    SimpleGroup* scene = new SimpleGroup();
    world.scene = scene;
...
void a_lighting() {
    ...
    renderCornellboxJ(0.001f, "a5-5.png");
    renderCornellboxJ(0.01f, "a5-6.png");
}
