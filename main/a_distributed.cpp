...
#include <rt/solids/motionsphere.h>
...
void renderCornellbox(float scale, const char* filename, Camera* cam, Material* sphereMaterial, Material* floorMaterial, int numSamples=1) {
    ...
    scene->add(new MotionSphere(Point(450.0f, 50.0f, 50.0f)*scale, 49.0f*scale, nullptr, yellowmat,Vector(0,1,0)));
...
void a_distributed() {
    ...
    //printf("7.3-b\n");
    //renderCornellbox(0.001f, "a7-3b.png", dofcam, sphereMaterial2, floorMaterial2, 100);
}
